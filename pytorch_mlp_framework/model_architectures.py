...
"""
Implementations for Batch Normalisation, Residual Connections and their combinations
"""

"""
Batch Normalisation Implementations
"""
##  Convolutional Batch Normalisation Block
class BatchNormConvBlock(nn.Module):
    ...
    def build_module(self):
        ...
        # Building and applying batchNorm layer 0
        self.layer_dict['bn_0'] = nn.BatchNorm2d(num_features=out.shape[1])
...
class BatchNormDimReductionConvBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(BatchNormDimReductionConvBlock, self).__init__()
...
"""
Blocks using Residual Connections AND Batch Normalisation
"""
##  Residual Connections Convolutional Block Implementation with Batch Normalisation
class ResidualBatchNormConvBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ResidualBatchNormConvBlock, self).__init__()
...
# Residual Connections Convolutional dimensionality reduction block with BN. Using average pooling for the dimensionality reduction in the shortcut connection
class ResidualBatchNormDimReductionConvBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ResidualBatchNormDimReductionConvBlock, self).__init__()
...
"""
Blocks using Residual Connections WITHOUT Batch Normalisation
"""
##  Residual Connections Convolutional Block Implementation WITHOUT Batch Normalisation
class ResidualConvProcessingBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ResidualConvProcessingBlock, self).__init__()
...
# Residual Connections Convolutional dimensionality reduction block WITHOUT BN. Using average pooling for the dimensionality reduction in the shortcut connection
class ResidualDimReductionConvBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ResidualDimReductionConvBlock, self).__init__()
